...
namespace ChessChallenge.Application
{
    public class ChallengeController
    {
        ...
        const string moveAudio = "/Users/kekaz16/Documents/Semester8/IC/Chess-Challenge/Chess-Challenge/resources/move-self.wav";

        const string captureAudio = "/Users/kekaz16/Documents/Semester8/IC/Chess-Challenge/Chess-Challenge/resources/capture.wav";
        ...
        void OnMoveChosen(Move chosenMove)
        {
            if (IsLegal(chosenMove))
            {
                ...
                {
                    if (IsCapture(chosenMove)) {player.Play(captureAudio);}
                    else {player.Play(moveAudio);}
        ...
        bool IsCapture(Move givenMove)
        {
            int capturedPieceType = PieceHelper.PieceType(board.Square[givenMove.TargetSquareIndex]);
            if (capturedPieceType != 0) {return true;}
            return false;   
        }
